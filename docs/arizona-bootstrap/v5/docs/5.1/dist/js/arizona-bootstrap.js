/*!
  * Arizona Bootstrap v5.1.2-omega12 (https://github.com/az-digital/arizona-bootstrap)
...
(function (global, factory) {
  ...
  function closeOtherDropdowns(navbar, currentDropdownElement) {
    ...
    for (var trigger of openTriggers) {
      ...
      if (instance !== null && instance !== void 0 && (_instance$isClickOpen = instance.isClickOpen) !== null && _instance$isClickOpen !== void 0 && _instance$isClickOpen.call(instance)) {
        continue;
      }
  ...
  function enableAzNavbar() {
    ...
    var handleOutsideInteraction = event => {
